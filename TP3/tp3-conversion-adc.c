 ...
 * Objectifs: Réaliser une conversion ADC et afficher le résultat sur un afficheur 7 segments
 * Fonctionnel
 * Limite : Précision dûe à la carte qui envoie 5.12 ou 5.13V mais une correction a été appliquée
 * Tests: 
 *  - Visualisation du signal à l'oscilloscope pour comparer avec la valeur affichée
 * 
 * Cablage: 
 *  - D0 à D7 sur a à g
...
void traitementConvSegment() {
    ...
    resultat1 = ((nombre * 19.65552941)); //  19.65... correspond à 5013/255
